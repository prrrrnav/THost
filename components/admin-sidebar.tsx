...
//         </div>
//         {!collapsed && (
//           <span className="text-sm font-semibold text-card-foreground">TheHost</span>
//         )}
//       </div>
...
//               <span className="truncate text-xs font-medium text-card-foreground">Rajesh Verma</span>
//               <span className="truncate text-[10px] text-muted-foreground">PG Owner</span>
//             </div>
//           )}
//           {!collapsed && (
...
export function AdminSidebar() {
  ...
  return (
    ...
    >
      {/* Absolute subtle right border glow */}
      <div className="absolute bottom-0 right-0 top-0 w-px bg-gradient-to-b from-transparent via-violet-500/20 to-transparent" />
      ...
      <div className="flex h-16 shrink-0 items-center gap-3 border-b border-white/5 px-4">
        <div className="relative group flex shrink-0 items-center justify-center">
          <div className="absolute -inset-1 rounded-lg bg-gradient-to-r from-violet-600 to-indigo-600 opacity-30 blur transition-opacity group-hover:opacity-60" />
        ...
        {!collapsed && (
          <span className="text-sm font-bold tracking-wide text-zinc-100">
            TheHost<span className="text-violet-500">.</span>
          </span>
        )}
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-violet-500/10 text-violet-300 border border-violet-500/20 shadow-[inset_0_0_12px_rgba(139,92,246,0.1)]"
